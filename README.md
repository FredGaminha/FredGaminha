...
<p align="left"> Atualmente tenho 27 anos e sou formado em <b>Análise e Desenvolvimento de Sistemas</b>.</p>
<p align="left"> Trabalho com criação de relatórios pelo banco de dados <b>Oracle</b>, e <b>MySQL</b>, faço criações de dashboards utilizando a ferramenta <b>Power BI</b> e crio automatizações utilizando o Python. Atualmente, estou aprendendo a desenvolver uma API com a utilização da framework <b>FastAPI</b> e <b>Flask</b> para desenvolvimento de uma rotina interna.</p>
